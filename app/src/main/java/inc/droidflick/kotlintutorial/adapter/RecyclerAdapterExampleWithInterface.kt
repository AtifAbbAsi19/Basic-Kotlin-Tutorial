...
import inc.droidflick.kotlintutorial.ui.interfaces.GetPositionListener


/**
 * Created by Muhammad Atif on 3/9/2018.
 */

class RecyclerAdapterExampleWithInterface(
        private val context: Context,
        private var list: ArrayList<User>,
        private var getPosition: GetPositionListener

) : RecyclerView.Adapter<RecyclerAdapterExampleWithInterface.ViewHolder>() {
